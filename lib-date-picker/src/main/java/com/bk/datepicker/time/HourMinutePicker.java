 ...
 */
public class HourMinutePicker extends LinearLayout implements
    ...
    public HourMinutePicker(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HourMinutePicker(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttrs(Context context, @Nullable AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.HourMinutePicker);
        int textSize = a.getDimensionPixelSize(R.styleable.HourMinutePicker_itemTextSize,
                getResources().getDimensionPixelSize(R.dimen.WheelItemTextSize));
        int textColor = a.getColor(R.styleable.HourMinutePicker_itemTextColor,
                Color.BLACK);
        boolean isTextGradual = a.getBoolean(R.styleable.HourMinutePicker_textGradual, true);
        boolean isCyclic = a.getBoolean(R.styleable.HourMinutePicker_wheelCyclic, true);
        int halfVisibleItemCount = a.getInteger(R.styleable.HourMinutePicker_halfVisibleItemCount, 2);
        int selectedItemTextColor = a.getColor(R.styleable.HourMinutePicker_selectedTextColor,
                getResources().getColor(R.color.datepicker_selectedTextColor));
        int selectedItemTextSize = a.getDimensionPixelSize(R.styleable.HourMinutePicker_selectedTextSize,
                getResources().getDimensionPixelSize(R.dimen.WheelSelectedItemTextSize));
        int itemWidthSpace = a.getDimensionPixelSize(R.styleable.HourMinutePicker_itemWidthSpace,
                getResources().getDimensionPixelOffset(R.dimen.WheelItemWidthSpace));
        int itemHeightSpace = a.getDimensionPixelSize(R.styleable.HourMinutePicker_itemHeightSpace,
                getResources().getDimensionPixelOffset(R.dimen.WheelItemHeightSpace));
        boolean isZoomInSelectedItem = a.getBoolean(R.styleable.HourMinutePicker_zoomInSelectedItem, true);
        boolean isShowCurtain = a.getBoolean(R.styleable.HourMinutePicker_wheelCurtain, true);
        int curtainColor = a.getColor(R.styleable.HourMinutePicker_wheelCurtainColor, Color.WHITE);
        boolean isShowCurtainBorder = a.getBoolean(R.styleable.HourMinutePicker_wheelCurtainBorder, true);
        int curtainBorderColor = a.getColor(R.styleable.HourMinutePicker_wheelCurtainBorderColor,
