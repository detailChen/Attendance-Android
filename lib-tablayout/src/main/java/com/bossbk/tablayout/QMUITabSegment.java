...
public class QMUITabSegment extends HorizontalScrollView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mDefaultNormalColor = QMUIResHelper.getAttrColor(context, R.attr.qmui_config_color_black);
        ...
        mItemSpaceInScrollMode = array.getDimensionPixelSize(R.styleable.QMUITabSegment_qmui_tab_space, QMUIHelper.dp2px(context, 10));
    ...
    private void createTypefaceProvider(Context context, String className) {
        if (QMUIHelper.isNullOrEmpty(className)) {
            return;
        }
    ...
    public void selectTab(final int index, boolean noAnimation, boolean fromTabClick) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                int preColor = QMUIHelper.computeColor(getTabSelectedColor(prevModel), getTabNormalColor(prevModel), animValue);
                int nowColor = QMUIHelper.computeColor(getTabNormalColor(nowModel), getTabSelectedColor(nowModel), animValue);
    ...
    private void layoutIndicatorInTransition(Tab preModel, Tab targetModel, float offsetPercent) {
        ...
        int indicatorColor = QMUIHelper.computeColor(
    ...
    public void updateIndicatorPosition(final int index, float offsetPercent) {
        ...
        int preColor = QMUIHelper.computeColor(getTabSelectedColor(preModel), getTabNormalColor(preModel), offsetPercent);
        int targetColor = QMUIHelper.computeColor(getTabNormalColor(targetModel), getTabSelectedColor(targetModel), offsetPercent);
    ...
    public static class Tab {
        ...
        public int getSignCount() {
            ...
            if (!QMUIHelper.isNullOrEmpty(mSignCountTextView.getText())) {
        ...
        private String getNumberDigitsFormattingValue(int number) {
            if (QMUIHelper.getNumberDigits(number) > mSignCountDigits) {
    ...
    public class TabItemView extends RelativeLayout {
        ...
        public void setColorInTransition(Tab tab, int color) {
            ...
            if (tab.isDynamicChangeIconColor()) {
                ...
                if (icon != null) {
                    QMUIHelper.setDrawableTintColor(icon, color);
        ...
        public void updateDecoration(Tab tab, boolean isSelected) {
            ...
            if (icon == null) {
                ...
                mTextView.setCompoundDrawablePadding(QMUIHelper.dp2px(getContext(), 4));
                setDrawable(mTextView, icon, getTabIconPosition(tab));
            }
        }
    }
