...
/**
*  java 1.8里的Optional迁移到低版本，部分方法使用rxJava2中的方法替代
*
*
...
public final class Optional<T> {
    ...
    *  return value
     ...
     * the need to explicitly check for a return state.  For example, the
     ...
     *         names.stream().filter(nickname -> !isProcessedYet(nickname))
     *                       .findFirst()
     *                       .map(nickname -> new FileInputStream(nickname));
     * }</pre>
     * <p>
