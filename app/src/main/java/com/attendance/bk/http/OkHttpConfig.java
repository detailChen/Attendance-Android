...
import com.attendance.bk.http.intercepters.HeaderInterceptor;
import com.attendance.bk.http.intercepters.NoNetCacheInterceptor;
...
//        public OkHttpConfig.Builder setCookieType(CookieStore cookieStore) {
...
//        }
        ...
        public Builder setNetInterceptor(Interceptor... netInterceptors) {
